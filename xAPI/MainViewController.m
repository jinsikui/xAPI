...
-(void)actionJson {
    ...
    .method(HTTP_GET)
//    .decodingType(xResponseDecncodingJSON) // default decodingType, the ret data will be JSON object
...
-(void)actionHttp {
    xAPI.host(@"https://www.baidu.com")
    .method(HTTP_GET)
    .path(@"/")
    .decodingType(xResponseDecncodingHTTP) // the ret data will be original NSData
